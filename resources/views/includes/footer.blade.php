...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-8 footer-right">
			...
			<div class>
				<div class="col-md-7"><h2><a href="index.html"><img src="{{ asset('logo/footer.png') }}" alt=" " /></a></h2>
			...
			et dolore magnam aliquam quaerat voluptatem.</p>
				...
				<div class="col-md-5 sign-gd flickr-post">
					...
					<ul>
						...
						<li><a href="single.html"><img src="{{ asset('logo/b15.jpg') }}" alt=" " class="img-responsive" /></a></li>
					</ul>
				</div>
				<div class="clearfix"></div>
			</div>
